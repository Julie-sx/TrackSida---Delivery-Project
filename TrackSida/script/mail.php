...
function sendTracksidaAlert(string $toEmail) {
    ...
    $from = "Tracksida <tracksida@hidia.fr>";
    ...
    $subject = "=?UTF-8?B?" . base64_encode("Message de prévention important concernant votre santé") . "?=";
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 20px 10px; background-color: #f3f2fa; color: #333333;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(110, 107, 202, 0.05); border: 1px solid #e6e4f4;">
            ...
            <div style="background: linear-gradient(135deg, #7b73e6, #6055cd); padding: 35px 20px; text-align: center;">
                ...
                <p style="color: #e3e1f8; margin: 5px 0 0 0; font-size: 13px; font-weight: 300;">Votre espace de prévention santé</p>
            </div>
            ...
            <div style="padding: 30px 25px;">
                ...
                <p style="font-size: 14px; line-height: 1.6; color: #4A4A4A; margin-top: 0;">
                    Pour faire le point et agir rapidement, nous vous invitons à utiliser notre outil en ligne :
                </p>
                
                <div style="text-align: center; margin: 30px 0 20px 0;">
                    <a href="https://tracksida.hidia.fr/" style="display: inline-block; background-color: #6e6bca; color: #ffffff !important; text-decoration: none; padding: 14px 30px; font-size: 14px; font-weight: bold; border-radius: 50px; box-shadow: 0 4px 10px rgba(110, 107, 202, 0.2);">
            ...
            <div style="text-align: center; padding: 20px; border-top: 1px solid #f0eef9; font-size: 11px; color: #8c89a8; background-color: #faf9fe;">
                ...
                &copy; ' . date('Y') . ' Tracksida &bull; Plateforme de prévention et de santé
            </div>
        </div>
    </body>
    </html>
